...
interface CreateSubscriptionGuestCommand {
...
export class CreateSubscriptionGuest {
  constructor(
    private readonly subscriptionGuestRepository: SubscriptionGuestRepository
  ) {}

  async make(command: CreateSubscriptionGuestCommand): Promise<void> {
    ...
    this.subscriptionGuestRepository.add(subscriptionGuest);
  }
}
